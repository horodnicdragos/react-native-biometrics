...
public class ReactNativeBiometrics extends ReactContextBaseJavaModule {
    ...
    @ReactMethod
    public void createKeys(String title, String cancelButtonText, String messageText, String hintText, String recognizedText, String notRecognizedText, Promise promise) {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                if (TextUtils.isEmpty(title)) {
                    ...
                    dialog.init(title, cancelButtonText, messageText, hintText, recognizedText, notRecognizedText, null, getCreationCallback(promise));
    ...
    @ReactMethod
    public void createSignature(String title, String cancelButtonText, String messageText, String hintText, String recognizedText, String notRecognizedText, String payload, Promise promise) {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ...
                ReactNativeBiometricsDialog dialog = new ReactNativeBiometricsDialog();
                dialog.init(title, cancelButtonText, messageText, hintText, recognizedText, notRecognizedText, cryptoObject, getSignatureCallback(payload, promise));
    ...
    @ReactMethod
    public void simplePrompt(String title, String cancelButtonText, String messageText, String hintText, String recognizedText, String notRecognizedText, Promise promise) {
        try {
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                ReactNativeBiometricsDialog dialog = new ReactNativeBiometricsDialog();
                dialog.init(title, cancelButtonText, messageText, hintText, recognizedText, notRecognizedText, null, getSimplePromptCallback(promise));
                Activity activity = getCurrentActivity();
                dialog.show(activity.getFragmentManager(), "fingerprint_dialog");
            } else {
